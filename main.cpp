 ...
 * 본 저작권자의 요구에 따라 GNU Affero GPL 을 따라 <>에 코드가 모두 공개되어 있습니다.
...
void byHand() {
  ...
  if (P.canPlay(COL-1)) {
    ...
    ISCIRCLE = !ISCIRCLE;
    std::cout << "\e[36m >> 착수점\e[38;5;255m : " << "\e[93m(" << COL << ',' << BOARD_COUNT[COL] << ")\e[38;5;255m\n";
...
// 기본적으로는 반드시 승리하는 수를 우선하여 둔다.
// 두지 않아 패배하게 되는 경우도 막게 된다.
  ...
  if (P.nbMoves() == 0) {
    ...
    if (b[1][1]!=' ' || b[3][2]!=' ' || b[4][1]!=' ' || b[6][1]!=' ' || b[7][1]!=' ') {
     ...
     if (b[1][1] == 'O' || b[7][1] == 'O') {
        ...
        if (b[2][2] == 'O') {
           ...
           std::cout << "\nRule - 4번 수가 룰인 경우, 2에 O가 있으며 [ (3,2) || 5 || 6 || 7 ] 에 O가 있다면 3에 둔다.\n";
           COL = 3;
        }
        else if (b[4][1] == 'O') {
        ...
        if (b[3][2] == 'O') {
           ...
           std::cout << "\nRule - 4번 수가 룰인 경우, 3에 O가 있으며 [ (4,2) || 5 || 6 || 7 ] 에 O가 있다면 4에 둔다.\n";
           COL = 4;
        }
     }
     else if (b[5][1] == 'O') {
        if (b[5][2] == 'O') {
           ...
           std::cout << "\nRule - 4번 수가 룰인 경우, 5에 O가 있으며 [ (4,2) || 6 || 7 ] 에 O가 있다면 4에 둔다.\n";
           COL = 4;
        }
     }
     else if (b[6][1] == 'O') {
        if (b[6][2] == 'O') {
           ...
           std::cout << "\nRule - 4번 수가 룰인 경우, 6에 O가 있으며 [ (5,2) || 7 ] 에 O가 있다면 5에 둔다.\n";
           COL = 5;
        }
        else if (b[4][1] == 'O') {
    ...
    if(b[1][1]=='X' && b[4][1]=='O'){
      if(b[1][2] == 'X' || b[3][2]=='X' || b[4][2]=='X' || b[5][1]=='X' ||b[7][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 1에 X가 있으며 (1,2) || (3,2) || (4,2) || (5,1) || (7,1) 에 X가 있다면 5에 둔다.\n";
        COL = 5;
      }
      else if(b[2][1] == 'X' || b[6][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 1에 X가 있으며 (2,1) || (6,1) 에 X가 있다면 2에 둔다.\n";
        COL = 2;
      }
    }
    else if(b[2][1]=='X'&& b[6][1]=='O'){
      if(b[1][1]=='X' || b[3][2]=='X'|| b[5][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 2에 X가 있으며 (1,1) || (3,2) || (5,1) 에 X가 있다면 3에 둔다.\n";
        COL = 3;
      }
      else if(b[2][2]=='X' || b[4][1]=='X' || b[6][2]=='X' || b[7][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 2에 X가 있으며 (2,2) || (4,1) || (6,2) || (7,1) 에 X가 있다면 6에 둔다.\n";
        COL = 6;
      }
    }
    else if(b[3][2]=='X' && b[4][1]=='O'){
      if(b[1][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, (3,2)에 X가 있으며 1에 X가 있다면 5에 둔다.\n";
        COL = 5;
      }
      else if(b[2][1]=='X' || b[3][3]=='X' || b[4][2]=='X' || b[5][1]=='X' ||b[6][1]=='X'||b[7][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, (3,2)에 X가 있으며 1에 X가 없다면 2에 둔다.\n";
        COL = 2;
      }
    }

    else if(b[4][1]=='X' && b[4][2]=='O'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, (4,1)에 X가 있으며 (4,2)에 O가 있다면 항상 4에 둔다.\n";
        COL = 4;
    }

    else if(b[5][1]=='X'&&b[3][2]=='O'){
      if(b[1][1]=='X' || b[2][1]=='X' ||b[4][1]=='X' ||b[5][2]=='X'||b[6][1]=='X'|| b[7][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, (5,1)에 X가 있으며 (3,3)에 X가 없다면 3에 둔다.\n";
        COL = 3;
      }
      else if(b[3][3]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, (5,1)에 X가 있으며 (3,3)에 X가 있다면 5에 둔다.\n";
        COL = 5;
      }
    }
      ...
      if(b[1][1]=='X' || b[3][2]=='X'|| b[4][2]=='X'||b[6][2]=='X'||b[7][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 6에 X가 있으며 (2,1)과 (5,1)에 X가 없다면 2에 둔다.\n";
        COL = 2;
      }
      else if(b[2][1]=='X' ){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 6에 X가 있으며 (2,1)에 X가 있다면 6에 둔다.\n";
        COL = 6;
      }
      else if(b[5][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 6에 X가 있으며 (5,1)에 X가 있다면 3에 둔다.\n";
        COL = 3;
      }
    }
    else if(b[7][1]=='X' && b[4][1]=='O') {
      if(b[1][1]=='X'||b[3][2]=='X'||b[4][2]=='X'||b[5][1]=='X'||b[7][2]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 7에 X가 있으며 (2,1)과 (6,1)에 X가 없다면 5에 둔다.\n";
        COL = 5;
      }
      else if(b[6][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 7에 X가 있으며 (6,1)에 X가 있다면 2에 둔다.\n";
        COL = 2;
      }
      else if(b[2][1]=='X'){
        std::cout <<"\nRule - 5번 수가 룰인 경우, 7에 X가 있으며 (2,1)에 X가 있다면 3에 둔다.\n";
        COL = 3;
      }
    }
  } else {
